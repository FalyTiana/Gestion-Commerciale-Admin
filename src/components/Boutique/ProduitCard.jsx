...
function ProduitCard({ produit }) {
    ...
    // Compter le nombre de caractéristiques disponibles
    const availableCharacteristicsCount = Object.keys(produit.variants[0].caracteristiques).length;
    return (
        <div className={styles.produitCard}>
            ...
            <div className={styles.containerBottom}>
                ...
                <div className={styles.containerCenter}>
                    ...
                    {availableCharacteristicsCount < 3 && (
                        <p className={availableCharacteristicsCount== 2? styles.ndr2 : availableCharacteristicsCount == 1? styles.ndr4 : styles.ndr6}>{produit.description ? produit.description : ""}</p>
                    )}
                </div>
